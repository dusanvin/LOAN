...
<p class="mb-8 flex items-center text-sm">
    <a href="{{ route('rooms.create') }}" class="hover:underline text-yellow-700 flex items-center">
        ...
        <tbody>
            @foreach($rooms as $room)
                <tr>
                    ...
                    <td class="border-b px-4 py-2 border-gray-600 text-sm break-words">
                        <span class="text-gray-400 text-xs">{{ $room->location }}</span>
                    </td>
                    <td class="border-b px-4 py-2 border-gray-600 break-words text-gray-400 text-xs">{{ $room->description }}</td>
