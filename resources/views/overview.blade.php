...
@section('content')
    ...
    <p class="mb-8 flex items-center">Eine Übersicht über alle ausgeliehenen Geräte. Bitte trage alle Geräte ein, die sich in der Ausleihe befinden. 
        <a href="{{ route('devices.create') }}" class="hover:underline text-yellow-700 flex items-center pl-1">
            Du möchtest ein Gerät verbuchen? Folge mir!
