...
@section('content')
    <h1 class="text-2xl font-bold mb-4">Ausleihe</h1>
    <p class="mb-8 flex items-center text-sm">Eine Übersicht über alle verliehenen Geräte.
        <a href="{{ route('devices.index') }}" class="hover:underline text-yellow-700 flex items-center pl-1">
            Du möchtest alle verfügbaren Geräte sehen? Folge mir!
